...
/*
CLOUD-ZOOM
<a rel="position:'right',adjustX:25,adjustY:0,Width: 432" href="a/product/zoom.jpg" class="cloud-zoom product-main-mainimage__item">
...
$('.speakers_count_1').animateNumber(
	{
	  number: 1106,
  ...
  $('.speakers_count_2').animateNumber(
	{
	  number: 580,
  ...
  $('.speakers_count_3').animateNumber(
	{
	  number: 354,
